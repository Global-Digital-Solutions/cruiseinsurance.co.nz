  ...
  return (
    <>
      <section className="relative bg-[#0c3b6e] text-white py-16 overflow-hidden">
        <div style={{ position: "absolute", inset: 0, backgroundImage: 'url(https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=1600&q=80)', backgroundSize: "cover", backgroundPosition: "center", opacity: 0.60 }} />
