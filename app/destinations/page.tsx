    ...
    <>
      <section className="relative bg-[#0c3b6e] text-white py-16 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1548574505-5e239809ee19?w=1600&q=80" alt="Cruise ship at sea — insurance by destination" className="w-full h-full object-cover" style={{ opacity: 0.80 }} />
