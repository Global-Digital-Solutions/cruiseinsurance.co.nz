    ...
    <>
      <section className="relative bg-slate-900 text-white py-16 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1600&q=80" alt="CruiseInsurance.co.nz — disclaimer" className="w-full h-full object-cover" style={{ opacity: 0.45 }} />
