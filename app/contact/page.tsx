    ...
    <>
      ...
      <section className="relative bg-slate-900 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1548574505-5e239809ee19?w=1920&q=80" alt="Cruise ship at sea" className="w-full h-full object-cover" style={{ opacity: 0.80 }} />
